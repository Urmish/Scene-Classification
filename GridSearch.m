...
s_dict_size = [512 1024 2048 4096];
s_nn = [2 3 4 5];
s_pyramid_level = [2 3 4];
...
for i_dict=1:size(s_dict_size,2)
    ...
    for i_n=1:size(s_nn,2)
        ...
        for i_pl = 1:size(s_pyramid_level,2)
            ...
            Matrix_Status(i_dict,i_n,i_pl) = mean_accuracy;
            outFName = fullfile('Grid', sprintf('Matrix_Status_%d_%d_%d.mat', params.dictionarySize, params.neighbors, params.pyramidLevels));
